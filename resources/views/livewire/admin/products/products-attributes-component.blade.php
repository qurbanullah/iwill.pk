<div class="mx-auto sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
    <div style="min-height: 770px" class="container mx-auto sm:relative md:h-full flex-col justify-between">
        <div class="container mx-auto">
            <div class="py-2">
                <div>
                    <h2 class="text-xl font-semibold leading-tight">Product Attributes</h2>
                </div>
                    ...
                    <div class="pt-4">
                        ...
                        >
                            ...
                            @if(!empty($this->image))
                                ...
                                <img src="{{ env('APP_URL') . '/product-attributes-images/' . $this->image }}">
        ...
        <div>
            <x-jet-dialog-modal wire:model="modalConfirmDeleteVisible">
                ...
                <x-slot name="content">
                    {{ __('Are you sure you want to delete this attribute? Once the attribute is deleted, all of its resources and data will be permanently deleted.') }}
                </x-slot>
