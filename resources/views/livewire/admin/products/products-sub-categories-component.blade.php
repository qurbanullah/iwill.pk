<div class="mx-auto sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
    <div style="min-height: 770px" class="container mx-auto sm:relative md:h-full flex-col justify-between">
        <div class="container mx-auto">
            <div class="py-2">
                <div>
                    <h2 class="text-xl font-semibold leading-tight">Product Sub Categories</h2>
                </div>
                            ...
                            <div class="overflow-hidden border border-solid border-slate-300 dark:border-slate-600 shadow rounded-lg">
                                ...
                                <table class="min-w-full divide-y divide-slate-300 dark:divide-slate-600 dark:bg-gray-800 dark:text-white">
                                    ...
                                    <tbody class="divide-y divide-slate-300 dark:divide-slate-600">
                                        @if (!empty($query))
                                            @if ($productSubCategoriesSearched->count())
                                                @foreach ($productSubCategoriesSearched as $item)
                                                    <tr>
                ...
                <br/>
                @if (!empty($query))
                    {{ $productSubCategoriesSearched->links() }}
                @else
            ...
            <x-jet-dialog-modal wire:model="modalFormVisible">
                ...
                <x-slot name="content">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <div class="mt-1 flex rounded-md shadow-sm">
                                    <span class="hidden md:inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 dark:bg-gray-500 dark:text-white text-sm">
                                        {{ config('app.url') . '/product-sub-categories/product-sub-category-show/' }}
                                    </span>
                    ...
                    <div class="pt-4 block">
                        <label class="text-base pr-4">
                            <span class="text-gray-700 dark:text-gray-100">Select Product Category:</span>
                        </label>
                        <select wire:model="productCategoryId"  class="bg-gray-200 dark:bg-gray-700 text-sm focus:outline-none focus:ring-1 focus:ring-gray-100 rounded text-gray-800 dark:text-gray-300 placeholder-gray-700 dark:placeholder-gray-400">
                            <option class="text-sm bg-gray-200 dark:bg-gray-700">Select Product Category</option>

                            @foreach($productCategories as $item)
                                <option class="text-sm bg-gray-200 dark:bg-gray-700" value="{{ $item->id }}">{{ $item->name }}</option>
                            @endforeach
                        </select>
