<div class="mx-auto sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
    <div style="min-height: 770px" class="container mx-auto sm:relative md:h-full flex-col justify-between">
        <div class="container mx-auto">
            <div class="py-2">
                <div>
                    <h2 class="text-xl font-semibold leading-tight">Product Vendors</h2>
                </div>
                    ...
                    <div class="w-full h-10 flex">
                        ...
                        <div class="flex justify-center">
                            <div class="relative">
                                ...
                                <input class="bg-gray-200 dark:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-sm text-gray-800 dark:text-gray-300 placeholder-gray-700 dark:placeholder-gray-400 pl-10" type="text" placeholder="Search" />
                            </div>
                        </div>
                    </div>
        ...
        <div>
            <x-jet-dialog-modal wire:model="modalFormVisible">
                ...
                <x-slot name="content">
                    ...
                    <div class="mt-4">
                        <x-jet-label for="vendor" value="{{ __('Slug') }}" class="text-lg dark:text-white" />
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <div class="mt-1 flex rounded-md shadow-sm">
                                    <span class="hidden md:inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 dark:bg-gray-500 dark:text-white text-sm">
                                        {{ config('app.url') . 'product-vendors/product-vendor-show/' }}
                                    </span>
        ...
        <div>
            <x-jet-dialog-modal wire:model="modalConfirmDeleteVisible">
                ...
                <x-slot name="content">
                    {{ __('Are you sure you want to delete this Vendor? Once the Vendor is deleted, all of its resources and data will be permanently deleted.') }}
                </x-slot>
