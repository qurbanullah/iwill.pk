            ...
            <div class="my-2 flex sm:flex-row flex-col">
                ...
                <div class="sm:w-2/12 mt-2 sm:flex justify-end text-right">
                    <div class="flex items-center justify-end text-right">
                        <a
                            class="pl-4 pt-2 pr-4 pb-2 bg-green-600 rounded-md hover:bg-blue-500"
                            href="{{ route('products.create-new-product') }}">
                            {{ __('Create') }}
                        </a>
                    </div>
                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:bg-gray-700 dark:text-white">
                                <thead>
                                    <tr class="dark:bg-gray-800">
                                        ...
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Regular Price</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Sale Price</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">SKU</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Stock Status</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Featured</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Quantity</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Product Banner Image</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Procuct Images</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Is Active</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Vendor</th>
                                        <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">Product Category</th>
                                            ...
                                            @foreach ($productsSearched as $item)
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 text-right text-sm">
                                                        <button>
                                                            <button wire:click="goToEditProduct({{ $item->id }})">
