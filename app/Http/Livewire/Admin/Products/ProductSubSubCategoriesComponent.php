...
class ProductSubSubCategoriesComponent extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    */
     ...
     * @return void
     */
    public function readProductSubSubCategory()
    {
        return ProductSubSubCategory::where('is_active', $this->isActive)
                                ->paginate($this->recordsToDisplay);
    }
    ...
    public function rules()
    {
        return [
            'name' => 'required',
            'slug' => ['required', Rule::unique('product_sub_sub_categories', 'slug')->ignore($this->modelId)],
            'content' => 'required',
    ...
    */
    ...
    public function update()
    {
        ...
        if($this->imageUploaded) {
            ...
            ProductSubSubCategory::find($this->modelId)->update($this->modelData());
            $this->modalFormVisible = false;
    ...
    {
        ProductSubSubCategory::destroy($this->modelId);
    ...
    */
    ...
    {
        $data = ProductSubSubCategory::find($this->modelId);
        $this->name = $data->name;
        $this->slug = $data->slug;
    ...
    */
    ...
    {
        return view('livewire.admin.products.product-sub-sub-categories-component', [
            'mainCategories' => $this->readMainCategory(),
            'productSubSubCategories' => $this->readProductSubSubCategory(),
            'productSubSubCategoriesSearched' => $this->readDatabaeForSearchQuery(),
