...
class ProductsCategoriesComponent extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    */
    ...
    {
        return ProductCategory::where('is_active', $this->isActive)
                                ->paginate($this->recordsToDisplay);
    }
    ...
    public function rules()
    {
        return [
            'name' => 'required',
            'slug' => ['required', Rule::unique('mysql_iwill_products.product_categories', 'slug')->ignore($this->modelId)],
            'content' => 'required',
        ];
    }
    ...
    */
    ...
    public function update()
    {
        try{
            ...
            $this->dispatchBrowserEvent('alert',
            ['type' => 'warning',  'message' => 'Error Updating Product.']);
        }
    }
    ...
    {
        $data = ProductCategory::find($this->modelId);
        $this->name = $data->name;
        $this->slug = $data->slug;
    ...
    {
        return view('livewire.admin.products.products-categories-component', [
            'data' => $this->readProductCategory(),
